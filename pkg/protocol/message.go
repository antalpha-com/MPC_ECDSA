...
// MarshalBinary serialize the message object into binary format.

func (m *Message) MarshalBinary() ([]byte, error) {
	// call the toMarshallable method to convert the message object into a serializable structure
	//use the CBOR  encoding format to serialize that structure into binary data
	return cbor.Marshal(m.toMarshallable())
}

// UnmarshalBinary function deserialize binary data into a message object.
