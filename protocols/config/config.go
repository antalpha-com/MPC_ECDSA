...
// 包含生成签名的所有信息，在生成/刷新密钥之后获得，耶代表SSID
type Config struct {
	...
	ChainKey types.RID
	// Public 所有参与方的公开信息 maps party.ID to public. It contains all public information associated to a party.
	Public map[party.ID]*Public
}

type ResharingInfo struct {
}
